...
Tags: Kobra Hover Effects, Hover Effects For Visual Composer, Hover Effects wordpress, CSS Animation, css effects, visual effects, VC hover effects, pure css3 effects, stylish image effects, text effects, wordpress image Hover,  wp image, wp portfolio effects, css3 hover effect, image hover, hover effect wordpress plugin, Visual Composer, Visual Composer Effects, image hover visual, Visucal Composer Effects
...
<li>5 square hover effects</li>
<li>5 Circle hover effects</li>
<li>5 Square2 hover effects</li>
