...
vc_add_shortcode_param( 'prime_slider', 'kobra_slider_range_settings', KOBRA_EXT_URL . '/admin/params/slider/js/slider-params.js');
function kobra_slider_range_settings( $settings, $value ) {
	$defaults = array(
		'min'        => 0,
		'max'        => 100,
		'step'       => 1,
