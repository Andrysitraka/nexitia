	...
	protected function content( $atts, $content = null ) {
		...
		if( ! empty( $sanjose_testimonials_slider_items ) && count( $sanjose_testimonials_slider_items ) > 0 ) { 
			$output .= '<div class="sanjose-testimonials-slider ' . $style_content .  ' ' . $class . '">';
                ...
                $output .= '<div class="swiper-container" data-autoplay="0" data-touch="1" data-mouse="0" data-speed="1000" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="' . $count_slide_sm . '" data-md-slides="' . $count_slide_md . '" data-lg-slides="' . $count_slide . '" ' . $data_canter . ' data-add-slides="' . $count_slide . '" data-loop="1" data-mode="horizontal">';
