				...
				$output .= '<div class="panel '.$active_wrap.'">';
                    ...
                    $output .= '<div class="panel-heading" role="tab" id="headingOne-1' . $counter . $accordion . '">';
                        $output .= '<h5 class="panel-title">';
                            $output .= '<a role="button" data-toggle="collapse" data-parent="#accordion-1' . $counter . $accordion . '" href="#collapseOne-1' . $counter . $accordion . '" aria-expanded="false" aria-controls="collapseOne-1' . $counter . $accordion . '" class="trans ' . $active_title . '">';
                    ...
                    // Text accordion
                    $output .= '<div id="collapseOne-1' . $counter . $accordion . '" class="panel-collapse collapse ' . $active . '" role="tabpanel" aria-labelledby="headingOne-1' . $counter . $accordion . '" aria-expanded="false">';
