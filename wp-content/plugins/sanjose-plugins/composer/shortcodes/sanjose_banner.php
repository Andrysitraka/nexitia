...
class WPBakeryShortCode_sanjose_banner extends WPBakeryShortCode
{
    protected function content($atts, $content = null)
    {
        ...
        $button = (!empty($banner_link['url'])) ? '<a data-color="' . $button_color .  '" href="' . $banner_link['url'] . '" ' . $banner_link_target . ' class="btn" style="'. $button_color_background .'  border-color: ' . $button_color . '; ' . $button_text_color_i . '">' . $banner_link['title'] . '</a>' : '';
